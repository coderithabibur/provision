<?php
class Controllertotalbganycombi extends Controller {	
	private $error = array();
	private $modpath = 'total/bganycombi'; 
	private $modtpl = 'total/bganycombi.tpl';
	...
	public function __construct($registry) {
		...
		if(substr(VERSION,0,3)>='3.0' || substr(VERSION,0,3)=='2.3') { 
			$this->modtpl = 'extension/total/bganycombi';
			$this->modpath = 'extension/total/bganycombi';
		} else if(substr(VERSION,0,3)=='2.2') {
			$this->modtpl = 'total/bganycombi';
		} 
		
		if(substr(VERSION,0,3)>='3.0') { 
			$this->modname = 'total_bganycombi';
