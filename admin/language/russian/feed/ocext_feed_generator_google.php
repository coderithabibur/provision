...
$_['text_setting_description'] = 'Источник для описания - <b>description</b> (<span style="color:red">обязательно</span>)';
...
$_['text_setting_available_by_quantity'] = 'Количество по реальным остаткам в товаре (или в сооответствующем значении опции, если включена передача вариаций по опциям) (<span style="color:red">обязательно</span>)</div>';
...
$_['text_general_setting_gm_cache_enable'] = 'Включить оптимизацию (для работы на слабых хостингах) <div class="small_text">Оптимизация может увеличить время создания файла. Оптимальный размер памяти ОЗУ хостинга (memory_limit): 768Мб на каждые 20000 товаров. Рекомендованное время работы скрипта (max_execution_time): 300 секнуд. Данные значение нужно установить на хостинге (как правило, в файле .htpacess)</div>';
$_['text_general_setting_gm_cache_level'] = 'Уровень оптимизации';
$_['text_general_setting_gm_cache_level_0'] = 'Максимальный (рекомендуется)';
$_['text_general_setting_gm_cache_level_1'] = 'Средний (файл создается быстрее, но требует больше ОЗУ)';
$_['text_general_setting_gm_cache_level_2'] = 'Минимальный (файл создается быстрее, но требует больше ОЗУ)';
...
$_['text_gps_info'] = 'Модуль предназначен не только для профессионального размещения в гугл мерчант, но и для просто размещения товаров. Для простого использования, укажите настройки, отмеченные, как обязательные. Обратите внимание, что в некоторых странах или для некоторых товаров существуют дополнительные обязательные настройки. Например, для простого использования нужно выбрать источник для названия товара (например название товара из карточки товара). Источник для сведений о количестве товара. Включайте только те теги, которые нужны для фида. Полный набор тегов, которые могут быть включены в фид для описания товара находится <a target="_blank" href="https://support.google.com/merchants/answer/7052112?">здесь</a>';
