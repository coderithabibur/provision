					...
					<tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
							...
							<table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
								...
								<tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
									<td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 40px 0 20px;" valign="top">
										Your customer <strong>{customer.name}</strong>, has a question about:
									</td>
								</tr>

                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                           <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; border-left: 2px solid #9BA2AB;  font-size: 14px; font-style: text-align:left; vertical-align: middle; margin: 0; padding: 10px 0 10px 20px;" valign="middle">
                              <strong>Product:</strong> <a href="{product.url}" style="color: #000; text-decoration: underline;">{product.name} - {product.model}</a>
                           </td>
                        </tr>
                        <tr>
                           <td height="20"></td>
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                           <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; background-color: #EDEFF2; box-sizing: border-box; border-left: 2px solid #9BA2AB; font-size: 14px; vertical-align: top; margin: 0; padding: 15px 20px;" valign="top">
                              <strong>Question:</strong><br /><br />{customer.question}
                           </td>
                        </tr>
                        <tr>
                           <td height="20"></td>
