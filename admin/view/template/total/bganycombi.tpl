      ...
      <div class="panel-body">
        ...
        <input type="hidden"  name="svsty" id="svsty" />
		  ...
		  <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="bganycombi_sort_order" value="<?php echo $bganycombi_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>   
        </form>
      </div>
