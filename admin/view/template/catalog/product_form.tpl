        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" name="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="url" name="video_link" value="<?php echo $video_link; ?>" placeholder= "Video link" id="video_link" class="form-control" />
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-2 control-label">Add Video Title</label>
                    <div class="col-sm-10">
                      <input type="text" name="video_title" value="<?php echo $video_title; ?>" placeholder= "Video Title" id="video_title" class="form-control" />
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>">Video Overview</label>
                    <div class="col-sm-10">
                      <textarea name="video_overview" placeholder="Video Overview "  rows="5" class="form-control" id="input-video-overview<?php echo $language['language_id']; ?>"><?php echo $video_overview ?></textarea>
                    </div>
                  </div>
                ...
                <div class="form-group">
                   ...
                   <!---->
                    <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>">Short Description</label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][short_description]" placeholder="Short Description"  rows="5" class="form-control" id="input-short-description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short_description'] : ''; ?></textarea>
                    </div>
                  </div>
   		   ...
   		   <!---->
                    <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>">Specification</label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][summary]" placeholder="Summary"  rows="5" class="form-control" id="input-summary<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['summary'] : ''; ?></textarea>
                    </div>
                  </div>
                   <!---->
                  <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price">Product Cost</label>
                <div class="col-sm-10">
                  <input type="text" name="product_cost" value="<?php echo $product_cost; ?>" placeholder="Product Cost" id="input-product-cost" class="form-control" />
                </div>
              </div>
     	      <div class="form-group">
                <label class="col-sm-2 control-label" for="input-each"><?php echo $entry_each; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="txt_each" value="<?php echo $txt_each; ?>" placeholder="<?php echo $entry_each; ?>" id="input-each" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo $entry_delivery_days; ?></label>
                    <div class="col-sm-10">
                      <input type="int" name="delivery_days" value="<?php echo $delivery_days;?>" placeholder="<?php echo $delivery_days; ?>" id="input-tag" class="form-control" />
                    </div>
                </div>
            </div>
...
$('#input-video-overview<?php echo $language['language_id']; ?>').summernote({height: 300});
$('#input-summary<?php echo $language['language_id']; ?>').summernote({height: 300});
<?php } ?>
//--></script>
