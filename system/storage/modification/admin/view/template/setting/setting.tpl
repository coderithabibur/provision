        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-facebook">Facebook Page</label>
                <div class="col-sm-10">
                  <input type="text" name="config_facebook" value="<?php echo $config_facebook; ?>" placeholder="<?php echo $config_facebook; ?>" id="input-insta" class="form-control" />
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_instagram" value="<?php echo $config_instagram; ?>" placeholder="<?php echo $config_instagram; ?>" id="input-insta" class="form-control" />
                  
                </div>
              </div>
 <div class="form-group">
                <label class="col-sm-2 control-label" for="input-google">Google Plus</label>
                <div class="col-sm-10">
                  <input type="text" name="config_google" value="<?php echo $config_google; ?>" placeholder="<?php echo $config_google; ?>" id="input-google" class="form-control" />
                  
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-youtube">You Tube</label>
                <div class="col-sm-10">
                  <input type="text" name="config_youtube" value="<?php echo $config_youtube; ?>" placeholder="<?php echo $config_youtube; ?>" id="input-youtube" class="form-control" />
                  
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-blogger">Blogger</label>
                <div class="col-sm-10">
                  <input type="text" name="config_blogger" value="<?php echo $config_blogger; ?>" placeholder="<?php echo $config_blogger; ?>" id="input-blogger" class="form-control" />
                  
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-linked">LinkedIn</label>
                <div class="col-sm-10">
                  <input type="text" name="config_linked" value="<?php echo $config_linked; ?>" placeholder="<?php echo $config_linked; ?>" id="input-linked" class="form-control" />
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_twitter" value="<?php echo $config_twitter; ?>" placeholder="<?php echo $config_twitter; ?>" id="input-twitter" class="form-control" />
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-fax">CloudFront Url</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_cloudfront_url" value="<?php echo $config_cloudfront_url; ?>" placeholder="CloudFront Url" id="input-config-cloudfront-url" class="form-control" />
                  </div>
                </div>
    ...
    <div class="form-group">
	  <label class="col-sm-2 control-label" for="input-twittersnippet-cardsize"><?php echo $text_twittercardsize; ?></label>
	  <div class="col-sm-10" style="display: inline-flex;">
	    <select name="config_twitter_cardsize" id="input-twittersnippet-cardsize" class="form-control twittersnippet_cardsize">
	      <?php if ($config_twitter_cardsize) { ?>
...
<style>
  label#input-config-cloudfront-url-error.error{
    color: #f56b6b;
  }
</style>
<?php echo $footer; ?>
