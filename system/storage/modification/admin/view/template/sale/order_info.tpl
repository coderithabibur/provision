...
//--></script>
			    ...
			    <script type="text/javascript">
                    $(document).ready(function() {
                    	...
                    	$('#ga-refund-block').load('index.php?route=extension/hbapps/google_ecommerce/ga_refund_block&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');
                    });
                </script>
