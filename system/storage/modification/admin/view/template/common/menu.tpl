  ...
  <li id="extension"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo $text_extension; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $feed; ?>"><?php echo $text_feed; ?></a></li>
				...
				<li><a href="<?php echo $apps_link; ?>"><?php echo $text_apps; ?></a></li>
				<li><a href="<?php echo $seo_link; ?>"><?php echo $text_seo; ?></a></li>
      ...
      <?php } ?>
			...
			<?php if (!empty($mpimportexport_menu)) { ?>
			<li id="<?php echo $mpimportexport_menu['id']; ?>"><a href="<?php echo $mpimportexport_menu['href']; ?>"><i class="fa <?php echo $mpimportexport_menu['icon']; ?> fa-fw"></i> <span><?php echo $mpimportexport_menu['name']; ?></span></a></li>
			<?php } ?>
  ...
  <li id="customer"><a class="parent"><i class="fa fa-user fa-fw"></i> <span><?php echo $text_customer; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $custom_field; ?>"><?php echo $text_custom_field; ?></a></li>
		...
		<li id="seo"><a class="parent"><i class="fa fa-cogs"></i><span><?php echo $text_headingtitle; ?></span></a>
     	 <ul>
     	 	 <li><a class="parent"><?php echo $text_autogenerators; ?></a>
		        <ul>
		      ...
		      <li><a class="parent"><?php echo $text_editor; ?></a>
		        <ul>
		      ...
		      <li><a href="<?php echo $report_completeseo; ?>"><?php echo $text_report; ?></a></li>
		      <li><a href="<?php echo $seo_settings; ?>"><?php echo $text_seo_setting; ?></a></li>

		       <li><a class="parent"><?php echo $text_socialrichsnippets; ?></a>
		        <ul>
		      ...
		      <li><a href="<?php echo $redirectmanager; ?>"><?php echo $text_redirectmanager; ?></a></li>
		      <li><a href="<?php echo $failedlinks; ?>"><?php echo $text_failedlinks; ?></a></li>
		      <li><a href="<?php echo $clearseo; ?>"><?php echo $text_clearseo; ?></a></li>
	      </ul>
	    </li>
  ...
  <li id="system"><a class="parent"><i class="fa fa-cog fa-fw"></i> <span><?php echo $text_system; ?></span></a>
    <ul>
      ...
      <!-- START: NitroPack.io (https://nitropack.io) -->
                <?php if (!empty($has_nitropack_access)) : ?>
                <li><a class="parent">NitroPack.io</a>
                  <ul>
                    <?php foreach ($nitropack_stores as $store) : ?>
        ...
        <ul>
          ...
          <li><a href="<?php echo $error_log; ?>"><?php echo $text_error_log; ?></a></li>
			...
			<li id="menu-product-question"><a class="parent"><i class="fa fa-commenting-o fa-fw"></i> <span><?php echo $text_menu_product_question; ?></span></a>
				<ul>
					<li><a href="<?php echo $product_question_setting; ?>"><?php echo $text_menu_setting; ?></a></li>
					<li><a href="<?php echo $product_question_question; ?>"><?php echo $text_menu_question; ?></a></li>
					<li><a href="<?php echo $product_question_help; ?>"><?php echo $text_menu_help; ?></a></li>
				</ul>
			</li>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_customer; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $report_subscribes; ?>" >Subcribers CSV</a></li>       
        </ul>
      </li>
...
<?php if(isset($bganycombi)) { ?> <li id="bganycombi"><a href="<?php echo $bganycombi; ?>"><i class="fa fa-arrow-right fa-fw"></i> <span>Buy Any Get Any Product Combination Pack</span></a></li> <?php } ?>
</ul>
