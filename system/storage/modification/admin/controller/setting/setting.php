...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['tab_server'] = $this->language->get('tab_server');
				...
				$data['text_twittercardsize'] = "Twitter Card Size";
		...
		if (isset($this->request->post['config_twitter_cardsize'])) {
			$data['config_twitter_cardsize'] = $this->request->post['config_twitter_cardsize'];
		} elseif ($this->config->get('config_twitter_cardsize')) {
			$data['config_twitter_cardsize'] = $this->config->get('config_twitter_cardsize');
		} else {
			$data['config_twitter_cardsize'] = '';
		}
		...
		if (isset($this->request->post['config_cloudfront_url'])) {
			$data['config_cloudfront_url'] = $this->request->post['config_cloudfront_url'];
		} else {
			$data['config_cloudfront_url'] = $this->config->get('config_cloudfront_url');
		}
		...
		if (isset($this->request->post['config_linked'])) {
			$data['config_linked'] = $this->request->post['config_linked'];
		} else {
			$data['config_linked'] = $this->config->get('config_linked');
		}
