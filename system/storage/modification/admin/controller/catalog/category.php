...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['google_category_gb'])) {
			...
			$data['google_category_gb'] = $category_info['google_category_gb'];
			$data['google_category_us'] = $category_info['google_category_us'];
			$data['google_category_au'] = $category_info['google_category_au'];
			$data['google_category_fr'] = $category_info['google_category_fr'];
			$data['google_category_de'] = $category_info['google_category_de'];
			$data['google_category_it'] = $category_info['google_category_it'];
			$data['google_category_nl'] = $category_info['google_category_nl'];
			$data['google_category_es'] = $category_info['google_category_es'];
			$data['google_category_pt'] = $category_info['google_category_pt'];
			$data['google_category_cz'] = $category_info['google_category_cz'];
			$data['google_category_jp'] = $category_info['google_category_jp'];
			$data['google_category_dk'] = $category_info['google_category_dk'];
			$data['google_category_no'] = $category_info['google_category_no'];
			$data['google_category_pl'] = $category_info['google_category_pl'];
			$data['google_category_ru'] = $category_info['google_category_ru'];
			$data['google_category_sv'] = $category_info['google_category_sv'];
			$data['google_category_tr'] = $category_info['google_category_tr'];
		} else {
