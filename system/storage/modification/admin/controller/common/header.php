...
class ControllerCommonHeader extends Controller {
	public function index() {
		$data['title'] = $this->document->getTitle();
			...
			$this->document->addScript('view/javascript/jquery/jquery.product-question-stats.js');
			$this->document->addStyle('view/stylesheet/product-question-stats.css');
			$this->document->addStyle('view/stylesheet/animate.css');
