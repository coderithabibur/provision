...
<?php if($config_google_pageid != "") { ?>
	...
	<?php } ?>
	<?php if(isset($plink)  && ($config_facebook_status || $config_pinterest_status)) { ?>
	<?php if(isset($pprice)) { ?>
	...
	<?php if(isset($pprice) && ($config_facebook_status || $config_pinterest_status)) { ?>
	...
	<meta property="og:price:currency" content="<?php echo $config_currency; ?>" />
	<?php } ?>
	<?php if(isset($pstock)) { ?>
	<meta property="og:availability" content="<?php echo ($pstock ? 'instock' : 'out of stock') ?>" />
	<?php } ?>
	<?php if(isset($pbrand)) { ?>
	<meta property="og:brand" content="<?php echo $pbrand; ?>" />
	<?php } ?>
	...
	<meta name="twitter:card" content="<?php echo ( $tcardsize ? "summary_large_image" : "summary") ?>" />
	<meta name="twitter:site" content="<?php echo $config_twitter_uername; ?>" />
	<meta name="twitter:title" content="<?php echo $title; ?>" />
	<?php if($description != "") { ?>
	<meta name="twitter:description" content="<?php echo $description; ?>" />
	<?php } ?>
	<?php if(isset($twitimage)) { ?>
	<meta name="twitter:image" content="<?php echo $twitimage; ?>" />
	<?php } ?>
