	...
	public function index() {
		...
		// START: NitroPack.io (https://nitropack.io)
                ...
                if (is_file(DIR_CONFIG . 'nitropackio/compatibility.php')) {
                    ...
                    $nitropack_action = new \Action($nitropack_config['route']['module']['nitropack'] . '/cartPlaceholder');
                    if (null !== $nitropack_script = $nitropack_action->execute($this->registry)) {
                        $data['nitropack_script'] = $nitropack_script;
                    }
                }
