...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			$data['refine_search_text'] = $category_info['refine_search_text'];
			$data['product_listing_text'] = $category_info['product_listing_text'];
			...
			if ($result['image']) {
				$data['cat_thumb'] = $this->model_tool_image->resize($result['image'], $this->config->get('config_image_category_width'), $this->config->get('config_image_category_height'));
			} else {
				$data['cat_thumb'] = '';
			}
				$filter_data = array(
    ...
    $link = $this->url->link('product/product', 'path=' . $this->request->get['path'] . '&product_id=' . $result['product_id'] . $url);
			...
			// http://googlewebmastercentral.blogspot.com/2011/09/pagination-with-relnext-and-relprev.html
				...
				if($this->config->get("nerdherd_direct_links")) {
					...
					$category_info['category_id'] = $this->request->get['path'];
				}
