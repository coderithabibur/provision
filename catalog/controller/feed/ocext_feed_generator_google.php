<?php
class ControllerFeedOcextFeedGeneratorGoogle extends Controller {
	private $shop = array();
	...
	private $eol = "\n";
        ...
        private $path_oc = 'feed';
        private $model_oc = 'feed';
        ...
        public function getDeliveryOption($tamplate_setting,$currency_code){
            ...
            foreach ($tamplate_setting['shipping'] as $delivery_options) {
                ...
                //$delivery_options['price'] = (float)trim($delivery_options['price']);
                $delivery_options['price'] = number_format(round((float)trim($delivery_options['price']),$decimal_place),2, '.', '');
                //number_format(round((float)trim($delivery_options['price']),$decimal_place),2, '.', '');
