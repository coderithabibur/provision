...
class ControllerInformationContact extends Controller {
	...
	protected function validate() {
		...
		if (!preg_match('/^[A-Z0-9][a-zA-Z0-9 ]+$/i', $this->request->post['name'])){
			$this->error['name'] = /*$this->language->get('error_name_valide')*/ "Enter valide name";
		}
		...
		if ((utf8_strlen($this->request->post['subject']) < 3) || (utf8_strlen($this->request->post['subject']) > 3000)) {
		$this->error['subject'] = $this->language->get('error_subject');
		}
		
		if ((utf8_strlen($this->request->post['phone']) < 10) || (utf8_strlen($this->request->post['phone']) > 15) || empty($this->request->post['phone'])) {
