...
class ControllerAccountRegister extends Controller {
	...
	private function validate() {
		...
		if(!preg_match('/^[a-zA-Z\s]+$/',$this->request->post['firstname'])){
			$this->error['firstname'] = $this->language->get('invalid_firstname');
		}

		if ((utf8_strlen(trim($this->request->post['lastname'])) < 1) || (utf8_strlen(trim($this->request->post['lastname'])) > 32)) {
			$this->error['lastname'] = $this->language->get('error_lastname');
		}
if(!preg_match('/^[a-zA-Z\s]+$/',$this->request->post['lastname'])){
			$this->error['lastname'] = $this->language->get('invalid_lastname');
		}
		...
		if ((utf8_strlen($this->request->post['telephone']) < 5) || (utf8_strlen($this->request->post['telephone']) > 15)) {
			$this->error['telephone'] = $this->language->get('error_telephone');
		}

if(!preg_match('/^[0-9]*$/', $this->request->post['telephone'])){
				$this->error['telephone']  = $this->language->get('invalid_telephone');
			}
		
		if (!preg_match('/^[0-9][0-9]*$/', $this->request->post['fax']) && !empty($this->request->post['fax'])) {
...
if (utf8_strlen($this->request->post['fax']) >1){ 
				if(!preg_match('/^[0-9]*$/', $this->request->post['fax'])){
					$this->error['fax'] = $this->language->get('invalid_fax');
				}
			}
...
if (utf8_strlen($this->request->post['postcode']) >1){ 
				if(!preg_match('/^[0-9]*$/', $this->request->post['postcode'])){
					$this->error['postcode'] = $this->language->get('invalid_postcode');
				}
			}
