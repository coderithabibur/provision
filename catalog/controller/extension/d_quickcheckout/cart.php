...
class ControllerExtensionDQuickcheckoutCart extends Controller {
    ...
    public function prepare($json){
        ...
        foreach ($products as $product) {
            ...
            $unit_cost = $this->getProductCost((int)$product['product_id']);
            ...
            $json['products'][] = array(
                ...
                'product_cost_raw' => $unit_cost,
                'product_cost'     => $this->currency->format($unit_cost, $this->session->data['currency']) // formatted
            );
            // fix for 2.1.0.0
