	...
	var methods = {
		...
		*/
		_buildPrompt: function(field, promptText, type, ajaxed, options) {
			...
			prompt.addClass("attention");
			prompt.addClass("icon");
			...
			var promptContent = $('<ul><li>').addClass("formErrorContent").html(promptText).appendTo(prompt);
			...
			if (options.showArrow) {
				var arrow = $('<ul><li>').addClass("formErrorArrow");
			...
			if(positionType === 'inline') {
				...
				jQuery('#'+field.attr("id")).addClass('error');
		 ...
		 _closePrompt: function(field) {
			 ...
			 if (prompt)
				 prompt.fadeTo("fast", 0, function() {
					 ...
					 prompt.remove();
					 jQuery('#'+field.attr("id")).removeClass('error');
				 });
		 },
