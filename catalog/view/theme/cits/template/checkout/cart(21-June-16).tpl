          ...
          <table>
           <tbody><tr class="tableHead">
              ...
              <tr>
                ...
                <td class="text-left">
                    <input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>"  class="qtyValue" />
                    ...
                    <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="crossIcon" onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><img src="catalog/view/theme/hidlighting/images/crossicon02.png" alt=""></button></td>
