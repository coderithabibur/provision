  ...
  <div id="collapse-shipping" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <div class="form-horizontal">
        ...
        <button type="button" id="button-quote" data-loading-text="<?php echo $text_loading; ?>" class="yellowbtn"><?php echo $button_quote; ?></button>
      </div>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '        <input type="button" value="<?php echo $button_shipping; ?>" id="button-shipping" data-loading-text="<?php echo $text_loading; ?>" class="yellowbtn" />';
				<?php } else { ?>
				html += '        <input type="button" value="<?php echo $button_shipping; ?>" id="button-shipping" data-loading-text="<?php echo $text_loading; ?>" class="yellowbtn" disabled="disabled" />';
				<?php } ?>
