    ...
    <div class="account-login-box">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <?php if($captcha){ ?>
          <div class="captchaContact required">
            <label class="col-sm-2 control-label" for="input-comment">Captcha</label>
          <?php echo $captcha; ?>
          </div>
          <?php } ?>
        </fieldset>
        ...
        <div class="buttons clearfix">
          ...
          <div class="pull-right"><?php echo $text_agree; ?>
            ...
            <?php } ?>
            <input type="submit" value="<?php echo $button_submit; ?>" class="yellowbtn" />
          </div>
        </div>
        <?php } else { ?>
        <div class="buttons clearfix">
