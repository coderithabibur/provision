...
<section class="greyBg paddingtop30">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"> <?php echo $content_top; ?>
      ...
      <span style="color: red; margin-bottom: 20px; display: block; padding-left: 50px;">  Note : For your security, Special Characters including Hyphens cannot be used</span>
