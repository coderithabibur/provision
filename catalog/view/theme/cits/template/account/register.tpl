...
<section class="greyBg paddingtop30">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <span style="color: red;">  Note : For your security, Special Characters including Hyphens cannot be used</span>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group required">
            <label class="col-sm-3 col-md-2  control-label" for="input-firstname"><?php echo $entry_firstname; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-lastname"><?php echo $entry_lastname; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-email"><?php echo $entry_email; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div class="form-group">
            <label class="col-sm-3 col-md-2 control-label" for="input-fax"><?php echo $entry_fax; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <label class="col-sm-3 col-md-2  control-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <label class="col-sm-3 col-md-2  control-label"><?php echo $custom_field['name']; ?></label>
            <div class="col-sm-9 col-md-10">
              <div>
                <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
                <div class="radio">
        ...
        <fieldset id="address">
          ...
          <div class="form-group">
            <label class="col-sm-3 col-md-2 control-label" for="input-company"><?php echo $entry_company; ?></label>
            <div class="col-sm-9 col-md-10">
              <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-company" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-address-1"><?php echo $entry_address_1; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div class="form-group">
            <label class="col-sm-3 col-md-2 control-label" for="input-address-2"><?php echo $entry_address_2; ?></label>
            <div class="col-sm-9 col-md-10">
              <input type="text" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-address-2" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-city"><?php echo $entry_city; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-postcode"><?php echo $entry_postcode; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-country"><?php echo $entry_country; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-zone"><?php echo $entry_zone; ?></label>
            <div class="col-sm-9 col-md-10">
        ...
        <fieldset>
          ...
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-password"><?php echo $entry_password; ?></label>
            <div class="col-sm-9 col-md-10">
          ...
          <div class="form-group required">
            <label class="col-sm-3 col-md-2 control-label" for="input-confirm"><?php echo $entry_confirm; ?></label>
            <div class="col-sm-9 col-md-10">
