...
<section class="acccount-section">
  ...
  <?php } ?>
  <div class="row" id="content"><?php echo $column_left; ?>
        ...
        <div class="orderTable table-responsive">
          ...
          <tr>
            ...
            <td class="text-right"><?php if ($product['price']) { ?>
              ...
              <?php } ?></td>
            <td class="text-left"><button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="yellowbtn btntbl"><i class="fa fa-shopping-cart"></i></button>
