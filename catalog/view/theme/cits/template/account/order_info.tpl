...
<section class="acccount-section">
  ...
  <?php if ($success) { ?>
  <div class="alert alert-success"><i class="glyphicon glyphicon-ok"></i> <?php echo $success; ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right" style="white-space: nowrap;"><?php if ($product['reorder']) { ?>
                <a href="<?php echo $product['reorder']; ?>" data-toggle="tooltip" title="<?php echo $button_reorder; ?>" class="yellowbtn btna2"><i class="fa fa-shopping-cart"></i></a>
                <?php } ?>
                <a href="<?php echo $product['return']; ?>" data-toggle="tooltip" title="<?php echo $button_return; ?>" class="btn btn-danger return"><i class="fa fa-reply"></i></a></td>
            </tr>
            <?php } ?>
