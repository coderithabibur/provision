...
<section class="bannerOuter paddingless">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <div class="pageTitle"><h1>Product detail</h1></div>
      </div>
    </div>
  </div>
</section>
     ...
     <?php echo $content_top; ?>
       <div class="row">
         ...
         <div class="productViewBox thumbnails">             
            ...
            <div class="productsmall"><a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"> <img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></div>          
            <?php } ?>
            <?php } ?>
              </div>        
          <?php } ?>          
          </div>
          <div class="col-md-7 col-sm-6 col-xs-6 fullBlock">
            <div class="productViewinfo">
           <?php if ($price) { ?>         
            <?php if (!$special) { ?>
              <p class="newprice"><?php echo $price; ?></p>
            <?php } else { ?>
            <span style="text-decoration: line-through;"><?php echo $price; ?></span>
             <p class="newprice"><?php echo $special; ?></p>
            </li>
            <?php } ?>
            <?php if ($tax) { /* ?>
           ...
           <p class="spl"><?php echo $text_points; ?> <span> <?php echo $points; ?></span></p>
            ...
            <p class="spl"><?php echo $discount['quantity']; ?><?php echo $text_discount; ?><span><?php echo $discount['price']; ?></span></p>
            <?php } ?>
            <?php } ?>        
          <?php } ?>
          <?php if ($manufacturer) { ?>
          ...
          <?php } ?>
            ...
            <div class="form-group qtyBlock">
              ...
              <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />         
               <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="yellowbtn Btn1"><?php echo $button_cart; ?> </button>
              ...
              <form class="form-horizontal" id="form-review">
                ...
                <div class="fullWidth required ">
                  <div class="halfwidth">
                    ...
                    <input type="text" name="name" value="" id="input-name" class="textfeild" />
                  </div>
                </div>
                <div class="fullWidth required">
                  <div class="halfwidth">
                    <label for="input-review"><?php echo $entry_review; ?></label>
                    <textarea name="text" rows="0" cols="0" id="input-review" class="textareafeild"></textarea>
                    <!--div class="help-block"><?php //echo $text_note; ?></div-->
                  </div>
                </div>
                <div class="fullWidth required">
                   <label><?php echo $entry_rating; ?>
                  <div class="radioset">                   
                    <input type="radio" name="rating" value="1" class="radio" />
                     <label class="title" for="onestar01">1 Star </label>
                    <input type="radio" name="rating" value="2" class="radio"/>
                     <label class="title" for="onestar01">2 Stars </label>
                    <input type="radio" name="rating" value="3" class="radio"/>
                     <label class="title" for="onestar01">3 Stars </label>
                    <input type="radio" name="rating" value="4" class="radio"/>
                     <label class="title" for="onestar01">4 Stars </label>
                    <input type="radio" name="rating" value="5" class="radio"/>
                     <label class="title" for="onestar01">5 Stars </label>
                  </div>
                </div>
                <div class="fullWidth required">
                ...
                <button type="button" id="button-review" data-loading-text="<?php echo $text_loading; ?>" class="yellowbtn"><?php echo "Post Comment"; ?></button>
                </div>               
                <?php } else { ?>
                <?php echo $text_login; ?>
                <?php } ?>
