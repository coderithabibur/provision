...
<script>
gtag('set', 'user_data', {
"email": yourEmailVariable, ***Change yourEmailVariable to the actual JavaScript variable name where you are storing the user’s email data. Do the same for the other variables below. Make sure that the values aren't hashed.
