      ...
      <table class="table table-bordered comparison">
        ...
        <tbody>
          ...
          <tr>
            ...
            <?php foreach ($products as $product) { ?>
            <td class="description"><?php echo $product['short_description']; ?></td>
            <?php } ?>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <?php foreach ($products as $product) { ?>
            <td><?php echo $product['height']; ?> x <?php echo $product['width']; ?> x <?php echo $product['length']; ?></td>
            <?php } ?>
          </tr>
        </tbody>
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><input type="button" value="<?php echo $button_cart; ?>" class="yellowbtn left" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" />
            <a href="<?php echo $product['remove']; ?>" class="yellowbtn right"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
      </div>
