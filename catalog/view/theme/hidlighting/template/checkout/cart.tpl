             ...
             <?php $i = 1; ?>
              ...
              <tr id="cross-<?php echo $i ?>">
                ...
                <td class="text-left">
                    ...
                    <input type="number" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>"  class="qtyValue" />
                    <button type="submit" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="refresh"><img src="catalog/view/theme/hidlighting/images/refreshicon.png" alt=""></button>
                    <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="crossIcon" value="Delete Row" onclick="cart.remove('<?php echo $product['cart_id']; ?>'); window.location.reload();"><img src="catalog/view/theme/hidlighting/images/crossicon02.png" alt=""></button></td>
...
-->
      ...
      <div class="buttonOuter">
        <div class="pull-left"><a href="<?php echo $continue; ?>" class="continue yellowbtn"><?php echo $button_shopping; ?></a></div>
        <div class="pull-right"><a href="<?php echo $checkout; ?>" class="continue proceedCheckout yellowbtn"><?php echo $button_checkout; ?></a></div>
      </div>
