...
if (typeof paypal_sdk === 'undefined') {
	...
	script.type = 'text/javascript';
	script.src = 'https://www.paypal.com/sdk/js?components=buttons,hosted-fields,messages&client-id=<?php echo $client_id; ?>&merchant-id=<?php echo $merchant_id; ?>&currency=<?php echo $currency_code; ?><?php if ($button_enable_funding) { ?>&enable-funding=<?php echo implode(',', $button_enable_funding); ?><?php } ?><?php if ($button_disable_funding) { ?>&disable-funding=<?php echo implode(',', $button_disable_funding); ?><?php } ?>';
