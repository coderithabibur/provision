...
<?php if(isset($bganycombi) && $bganycombi) { ?> <li id="bganycombi"><a href="<?php echo $bganycombi; ?>"><i class="fa fa-arrow-right fa-fw"></i> <span>Buy Any Get Any Product Combination Pack</span></a></li> <?php } ?>
